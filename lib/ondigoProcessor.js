 ...
 *     line to one Vendor/Expense Account, edited on Mapping Master's
 *     Ondigo tab (`ondigo_defaults` — same "Defaults" pattern as AR
 *     Deposits) rather than hardcoded.
 ...
 */
export function buildOndigoBillRows(rawRows, storeMaster, addressMappings = [], defaults = {}) {
