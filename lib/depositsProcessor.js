 ...
 *     import template header, not a typo to "fix") = Store Master's own
 *     `company_name` verbatim (e.g. "RBFC YOUNGSTOWN LLC"), same as every
 *     other company grouping in this app — not a shortened label.
