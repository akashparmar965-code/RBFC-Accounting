...
/**
 * Allocate company-wise JV lines equally across that company's Active
 * stores (e.g. $1200 for a company with 12 Active stores -> $100/store),
 * independent per line — no cross-company blending.
 *
 * @param {Array} lines - [{ account_name, company_name, debit, credit }]
