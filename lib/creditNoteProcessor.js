 ...
 * feature was built against, so −Discount and +Shipping Cost above are
 * unverified against a real nonzero example (unlike Other Cost/Other
 * Deductions, which did appear nonzero and were confirmed). Per explicit
 * request, any invoice with a nonzero Discount or Shipping Cost is
  ...
  for (const row of rawRows) {
    ...
    if (!invoices[invoiceKey]) {
      invoices[invoiceKey] = {
        ...
        subAmount: toNumber(row["Sub Amount"]),
